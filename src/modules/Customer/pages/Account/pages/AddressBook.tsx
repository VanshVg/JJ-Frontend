      ...
      <div>
        <div className="lg:flex lg:items-center lg:justify-center lg:mt-4">
          <div className="p-2 w-full lg:w-[33%] lg:items-center">
            <div
              className={`rounded-lg bg-primary mt-2 p-2 flex justify-between items-center cursor-pointer text-white lg:h-[145px] lg:rounded-md lg:border-[1px] lg:border-primary lg:bg-primary lg:p-0 lg:mt-0`}
            >
          ...
          <div className="w-[90%] mx-auto lg:w-[33%]">
